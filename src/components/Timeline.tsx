...
const Timeline = () => {
  return (
    <main className="w-[50%] h-full min-h-screen flex flex-col border-l-[0.5px] border-r-[0.5px] border-gray-600">
            ...
            >
              ...
              <div className="flex flex-col">
                ...
                <div className="text-white text-base my-1">
                  ...
                  Deleniti explicabo illo quisquam omnis, qui hic culpa magni
                  nihil at incidunt!
                </div>
